...
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_SETTINGS,
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_URL,
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_CODE_URL,
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_TOKEN_URL,
   "URL where to get an access token using OAuth2"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_WEBHOOK_START_ASSOCIATION,
   "Start association with website"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_START_ASSOCIATION,
   "Start a secure association between the emulator and the 3rd party website"
   )
MSG_HASH(
   MENU_ENUM_LABEL_VALUE_WEBHOOK_ABORT_ASSOCIATION,
   "Cancel association with website"
   )
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_ABORT_ASSOCIATION,
...
MSG_HASH(
   MENU_ENUM_SUBLABEL_WEBHOOK_CODE,
