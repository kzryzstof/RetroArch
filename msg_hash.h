...
/* MENU_ENUM_LABEL_INPUT_PLAYER1_JOYPAD_INDEX,
   ...
   MENU_LABEL(WEBHOOK_SETTINGS),
   MENU_LABEL(WEBHOOK_URL),
   MENU_LABEL(WEBHOOK_CODE_URL),
   MENU_LABEL(WEBHOOK_TOKEN_URL),
   MENU_LABEL(WEBHOOK_START_ASSOCIATION),
   MENU_LABEL(WEBHOOK_ABORT_ASSOCIATION),
   MENU_LABEL(WEBHOOK_CODE),
