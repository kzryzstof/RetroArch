...
typedef struct settings
{
   ...
   struct
   {
      ...
      char webhook_code_url[512];
      char webhook_token_url[512];
      char webhook_usercode[128];
      char webhook_accesstoken[1024];
      char webhook_refreshtoken[1024];
      char webhook_expiresin[64];
